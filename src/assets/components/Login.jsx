      ...
      <div className='flex flex-col items-center'>
        ...
        {!loginStatus ?<div className='mb-2 w-full'><Alert severity="error">Invalid email or password.</Alert></div>:''}
          <div className='flex flex-col w-full'>
            ...
            <input ref={email} onChange={formik.handleChange} value={formik.values.email} type="email" id='email' name='email' className='rounded w-[95vw] sm:w-[400px] border-gray-300 border-2 focus:border-[#000] focus:ring-0' />
          </div>

          <div className='flex flex-col w-full mt-2'>
            <label htmlFor="password">Password:</label>
            <input ref={password} onChange={formik.handleChange} value={formik.values.password} type="password" id='password' name='password' className='rounded w-[95vw] sm:w-[400px] border-gray-300 border-2 focus:border-[#000] focus:ring-0' />
          </div>

          
          <button type='submit' className='bg-black text-white sm:w-[400px] w-full py-2 rounded mt-3'>login now</button>
          <Link to={'/forgetpassword'} className='mt-2 text-gray-500 block hover:text-black font-[500] transition-colors'>forget your password?</Link>
