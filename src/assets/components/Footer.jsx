...
export default function Footer() {
  return (
    <div className='bg-custom-gray w-full py-5 text-sm md:text-base'>
      <div className="container">
        ...
        <div className='w-full flex md:flex-nowrap flex-wrap justify-center items-center gap-x-10 gap-y-3 my-3'>
          <input type="email" className='md:w-3/4 w-full rounded' placeholder='Email ..'/>
          <button className='md:w-1/4 w-full py-2 bg-gray-600 text-white rounded'>Share App Link</button>
        </div>
