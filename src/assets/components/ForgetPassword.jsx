...
export default function ForgetPassword() {
  ...
  return (
    <div className='flex flex-col items-center py-16'>
      ...
      <div className='flex justify-center items-center w-[80px] h-[80px] bg-gray-50 dark:bg-[#1b1b1b] rounded-full'>
        <div className='flex justify-center items-center w-[60px] h-[60px] bg-gray-200 dark:bg-[#1b1b1b] rounded-full'>
